...
#      12) Update MGI Home.
#      13) Wait for the flags to signal that the public Fewi and QS have
#          been restarted.
#      14) Toggle the inactive public setting.
#      15) Send email notification that the public update has completed.
#
#  Notes:  None
#
###########################################################################
